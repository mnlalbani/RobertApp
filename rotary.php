...
<body >
	...
	<section class="portada">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="imagen-top-rotary">
					<div class="overlay-top"><h2>rotary internacional</h2></div>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="nos-izq">
						<hr align="left">
						<h2>Somos mas de un millón doscientos mil socios </h2>
					</div>
				</div>
				<div class="col-md-8">
					<div class="nos-de">
	...
	<section class="contenido-img-rotary">
		
		<div class="row">
				<div class="imagen1rotary">
					
				</div>
				<div class="imagen2rotary">
					
				</div>
			
				<div class="imagen3rotary">
					
				</div>
				<div class="imagen4rotary">
