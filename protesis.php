...
<body >
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid container-arre">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="protesis.php">PROTESIS</a></li>
	...
	<section class="portada">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="imagen-top-prote">
					<div class="overlay-top"><h2>fabricacion de protesis</h2></div>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="rehab-top">
		<div class="row">
			<div class="col-md-12">
				<h2>sala de protesis el desvalido</h2>
