<?php 
	...
	$mysqli->close();
	$data['success'] = true;
	$data['message'] = "<p style='margin:10px 0 0 0; text-transform:uppercase; font-size:20px; font-weight:bold; border:2px solid #4cd964;' class='alert alert-success'> <i class='fa fa-check'></i> Usuario Registrado</p>" ;
	echo json_encode($data);
}
 ?>